...
pCT.on("click", function (e) {
  ...
  if (sessionStorage.getItem("codDocumento") != null) {
    ...
    document.getElementById("avvisoLog").innerHTML =
      "Prima di effettuare un noleggio devi effettuare il login.";
  }
});
//Palermo
...
function NolCatania() {
  ...
  if (titolo == "Noleggio") CercaBarche(2);
}
...
function NolPalermo() {
  ...
  nolGenova.style.display = "none";
  contBarche.innerHTML = "";
  if (titolo == "Noleggio") CercaBarche(6);
}
...
function NolPortoCervo() {
  ...
  nolGenova.style.display = "none";
  contBarche.innerHTML = "";
  if (titolo == "Noleggio") CercaBarche(5);
}
...
function NolVenezia() {
  ...
  nolGenova.style.display = "none";
  contBarche.innerHTML = "";
  if (titolo == "Noleggio") CercaBarche(3);
}
...
function NolNapoli() {
  ...
  nolGenova.style.display = "none";
  contBarche.innerHTML = "";
  if (titolo == "Noleggio") CercaBarche(1);
}
...
function NolGenova() {
  ...
  contBarche.innerHTML = "";
  if (titolo == "Noleggio") CercaBarche(4);
}
